...
const JobDescription = () => {
    ...
    <h1 className='border-b-2 border-b-gray-200 font-medium py-4'>Frontend Developer</h1>
    <div>
        ...
        <h1 className='font-bold my-1'>Description: <span className='pl-4 font-normal text-gray-800'> Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quod, vel. </span></h1>
        ...
        <h1 className='font-bold my-1'>Total Applicant: <span className='pl-4 font-normal text-gray-800'> 2 </span></h1>
        <h1 className='font-bold my-1'>Posted Date: <span className='pl-4 font-normal text-gray-800'> 10-10-2026 </span></h1>
